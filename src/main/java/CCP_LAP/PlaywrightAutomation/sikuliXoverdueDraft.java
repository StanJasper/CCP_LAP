	...
	public static void main(String[] args) throws Exception {
		...
		try {
			...
			Pattern Draftmode = new Pattern(
					"D:\\1_Jasper\\Automation\\workspace\\PlaywrightAutomation\\src\\main\\java\\resources\\images\\DraftMode.png");
		...
		//	screen.paste(InstNo, "567005");			
	        ...
	        String InstNo = instrumentNoGenerator.generateSixDigitNumber();
	        System.out.println("Generated Instrument Number: " + InstNo);

	        Pattern InstnoField = new Pattern("D:\\1_Jasper\\Automation\\workspace\\PlaywrightAutomation\\src\\main\\java\\resources\\images\\InstrumentNo.png");
	        screen.click(InstnoField);
	        screen.paste(InstNo);
